...
fun Page1(modifier: Modifier = Modifier) {
    Column(
        ...
        Text("Page1", fontSize = 34.sp, fontWeight = FontWeight.Bold)
    }
...
fun Page2(modifier: Modifier = Modifier) {
    Column(
        ...
        Text("Page2", fontSize = 34.sp, fontWeight = FontWeight.Bold)
    }
...
fun Page3(modifier: Modifier = Modifier) {
    Column(
        ...
        Text("Page3", fontSize = 34.sp, fontWeight = FontWeight.Bold)
    }
